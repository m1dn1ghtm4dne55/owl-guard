...
HELP_INFO = 'LOG_FILE_MAX_BYTES is integer | TELEGRAM_USER_ID is integer | TELEGRAM_BOT_TOKEN is token | WEBHOOK_URL is url | DBUS_CORE_SESSION_TIMEOUT is float or integer'
